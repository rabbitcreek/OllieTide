...
const int EMERGENCY_STOP_PINB = 26; //define the IO PIN the emergency stop switch is connected to downtide limit
const int EMERGENCY_STOP_PINT= 32;// this is for the uptide limit of the lead screw
// Speed settings
const int DISTANCE_TO_TRAVEL_IN_STEPS = 500;
const int SPEED_IN_STEPS_PER_SECOND = 2000;
const int ACCELERATION_IN_STEPS_PER_SECOND = 2000;
const int DECELERATION_IN_STEPS_PER_SECOND = 2000;
double epic;
double epic2;
int que = 0;
int counterBabe = 0;
...
for(int z = 0; z < 15; z++){
  ...
  client.print("/api/v3?today&extremes&lat=20.783&lon=-156.467&localtime&datum=CD&key=PlaceApikeyhere"); // %2C == ,
